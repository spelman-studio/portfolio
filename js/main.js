...
(function(html) {
    ...
    * ------------------------------------------------------ */
    const ssScrollReveal = function() {
        ...
        const revealElements = document.querySelectorAll('.reveal-content, .folio-item, .counter, .swiper-slide');
   ...
   /* animated counters
    * ------------------------------------------------------ */
    const ssAnimateCounters = function() {

        const counterElements = document.querySelectorAll('.numbers__number');
        ...
        const countUpInView = new IntersectionObserver(function(entries, observer) {
            entries.forEach(function(entry) {
        ...
        counterElements.forEach(function(element) {
            countUpInView.observe(element);
        });

    }; // end ssAnimateCounters


   /* portfolio item stagger
    * ------------------------------------------------------ */
    const ssFolioStagger = function() {
   ...
   /* header nav entrance
    * ------------------------------------------------------ */
    const ssHeaderNavEntrance = function() {
    ...
    }; // end ssHeaderNavEntrance


   /* interactive hover zones
    * ------------------------------------------------------ */
    const ssIntractiveHovers = function() {
        ...
        // Social link interaction with shimmer
        socialLinks.forEach(function(link) {
            link.addEventListener('mouseenter', function() {
                this.style.filter = 'drop-shadow(0 0 8px rgba(142, 58, 124, 0.6))';
            });

            link.addEventListener('mouseleave', function() {
                this.style.filter = 'drop-shadow(0 0 0 rgba(142, 58, 124, 0))';
            });
        });

    }; // end ssIntractiveHovers


   /* plum particle animation
    * ------------------------------------------------------ */
    const createPlumParticles = function() {
        const count = 25;
        for (let i = 0; i < count; i++) {
            const p = document.createElement('div');
            p.className = 'plum-particle';
